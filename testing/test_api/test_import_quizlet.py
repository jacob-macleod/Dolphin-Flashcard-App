...
class TestQuizletImport(BaseApiActionsMixin):
    ...
    def test_quizlet_import_valid_double_newLine(self):
        ...
        # Test data
        with open(
            "testing/test_api/flashcard_format/test_quizlet_import_double_newline_seperator.txt",
            "r",
        ) as file:
            content = file.read()
    ...
    def test_quizlet_import_valid_comma_sep(self):
        ...
        # Test data
        with open(
            "testing/test_api/flashcard_format/test_quizlet_import_semicolon_seperator.txt",
            "r",
        ) as file:
            content = file.read()
    ...
    def test_quizlet_import_valid_comma_semicolon_sep(self):
        ...
        # Test data
        with open(
            "testing/test_api/flashcard_format/test_quizlet_import_comma_semicolon_seperator.txt",
            "r",
        ) as file:
            content = file.read()
        quizlet_data = {
    ...
    def test_quizlet_import_newline(self):
        ...
        # Test data
        with open(
            "testing/test_api/flashcard_format/test_quizlet_import_newline.txt", "r"
        ) as file:
            content = file.read()
