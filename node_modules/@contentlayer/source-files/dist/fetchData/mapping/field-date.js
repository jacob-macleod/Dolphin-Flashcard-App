...
export const makeDateField = ({ dateString, fieldName, options, }) => pipe(T.try(() => {
...
}), T.catchAll(() => FetchDataError.IncompatibleFieldDataError.fail({ incompatibleFieldData: [[fieldName, dateString]] })));
