...
exports.assertNonNegative = exports.Acquisition = void 0;
...
const assertNonNegative = n => n < 0 ? T.die(`Unexpected negative value ${n} passed to acquireN or releaseN.`) : T.unit;
