...
exports.zipAllSortedByKeyLeft_ = zipAllSortedByKeyLeft_;
...
function zipAllSortedByKeyLeft_(self, that, default_, ord) {
  return ZipAllSortedByKeyWith.zipAllSortedByKeyWith_(self, that, _index.identity, _ => default_, (a, _) => a, ord);
}
/**
 * Zips this stream that is sorted by distinct keys and the specified
 * stream that is sorted by distinct keys to produce a new stream that is
