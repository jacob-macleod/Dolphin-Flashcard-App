...
function replace(key, finalizer) {
  return _ => T.flatten(R.modify_(_.ref, s => {
    switch (s._tag) {
      case "Exited":
        return Tp.tuple(T.map_(finalizer(s.exit), () => O.none), new _Exited.Exited(s.nextKey, s.exit));

      case "Running":
        return Tp.tuple(T.succeed((0, _core.lookup)(key)(s.finalizers())), new _Running.Running(s.nextKey, (0, _core.insert)(key, finalizer)(s.finalizers())));

      default:
        return (0, _index2.absurd)(s);
    }
  }));
}
