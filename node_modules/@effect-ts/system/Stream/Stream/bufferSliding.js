...
exports.bufferSliding_ = bufferSliding_;
...
function bufferSliding_(self, capacity) {
  return new _definitions.Stream(M.chain_(M.bind_(M.do, "queue", () => T.toManagedRelease_(Q.makeSliding(capacity), Q.shutdown)), ({
    queue
...
//# sourceMappingURL=bufferSliding.js.map