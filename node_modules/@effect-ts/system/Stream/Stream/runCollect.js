...
exports.runList = exports.runCollect = void 0;
 ...
 */
const runCollect = self => T.map_((0, _run.run)(SK.collectAll())(self), A.toArray);
/**
 * Runs the stream and collects all of its elements to an array.
 */
...
const runList = self => (0, _run.run)(SK.collectAllToList())(self);
