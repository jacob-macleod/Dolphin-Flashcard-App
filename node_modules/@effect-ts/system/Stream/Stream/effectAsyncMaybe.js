...
exports.effectAsyncMaybe = effectAsyncMaybe;
...
function effectAsyncMaybe(register, outputBuffer = 16) {
  return new _definitions.Stream(M.map_(M.bind_(M.bind_(M.bind_(M.bind_(M.do, "output", () => T.toManaged(Q.makeBounded(outputBuffer))), "runtime", () => T.toManaged(T.runtime())), "maybeStream", ({
    output,
    runtime
