...
function broadcastDynamic_(self, maximumLag) {
  return M.map_((0, _broadcastedQueuesDynamic.broadcastedQueuesDynamic_)(self, maximumLag), _ => (0, _flattenTake.flattenTake)((0, _chain.chain_)((0, _managed2.managed)(_), _fromQueue.fromQueue)));
}
/**
 * Fan out the stream, producing a dynamic number of streams that have the same elements as this stream.
 * The driver stream will only ever advance of the `maximumLag` chunks before the
