...
function fromQueue(queue) {
  return (0, _repeatEffectChunkOption.repeatEffectChunkOption)(T.catchAllCause_(Q.takeBetween_(queue, 1, Number.MAX_SAFE_INTEGER), c => T.chain_(Q.isShutdown(queue), down => down && C.interrupted(c) ? Pull.end : Pull.halt(c))));
}
