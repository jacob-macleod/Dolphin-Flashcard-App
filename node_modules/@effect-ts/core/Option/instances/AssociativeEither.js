...
exports.AssociativeEither = void 0;

var _Either = /*#__PURE__*/require("@effect-ts/system/Either");
...
const AssociativeEither = {
  orElseEither: fb => fa => fa._tag === "Some" ? O.some((0, _Either.left)(fa.value)) : O.map_(fb(), _Either.right)
};
