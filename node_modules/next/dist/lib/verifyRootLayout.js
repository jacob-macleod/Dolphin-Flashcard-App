...
async function verifyRootLayout({ dir, appDir, tsconfigPath, pagePath, pageExtensions }) {
    ...
    try {
        ...
        if (typeof availableDir === "string") {
            ...
            console.log((0, _picocolors.green)(`\nYour page ${(0, _picocolors.bold)(`app/${normalizedPagePath}`)} did not have a root layout. We created ${(0, _picocolors.bold)(`app${rootLayoutPath.replace(appDir, "")}`)} for you.`) + "\n");
            // Created root layout
            return [
                true,
                rootLayoutPath
