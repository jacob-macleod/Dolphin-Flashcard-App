...
docker run --env "FIRESTORE_PROJECT_ID=dummy-project-id" --env "PORT=8080" mtlynch/firestore-emulator-docker --publish 080:8080 mtlynch/firestore-emulator-docker
