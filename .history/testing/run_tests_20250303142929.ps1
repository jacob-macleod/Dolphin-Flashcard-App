...
Start-Process powershell -ArgumentList "-Command python backend/main.py" -WindowStyle Hidden

# Wait for services to start
$SECONDS_TO_WAIT = 10
Write-Host "Waiting $SECONDS_TO_WAIT seconds for services to start..."
