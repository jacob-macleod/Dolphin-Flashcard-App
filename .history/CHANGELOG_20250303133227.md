...
- Added new API route `/api/import-from-quizlet` to import flashcard sets directly from Quizlet URLs
- Implemented scraping functionality to extract terms, definitions, title and description from Quizlet sets
- Automatic folder creation if importing to a non-existent folder
