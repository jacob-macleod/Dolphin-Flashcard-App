...
function Flashcards() {
    ...
    return (
        <div style={{ top: "0px" }}>
            ...
            >
                {view !== "mobile" ? (
                    <SidePanel selectedItem="flashcards" />
                ) : (
                    <></>
                )}
                                        ...
                                        {view === "mobile" ? (
                                            <>
                                                <PillGhostButton
                                                    ...
                                                    onClick={() => {
                                                        setCreateFolderDialogueVisible(
                                                            todayCards
                                                        );
                                                    }}
                                                    view={view}
                                ...
                                <div style={{ textAlign: "left" }}>
                                    ...
                                    {ankiImportsEnabled && (
                                        <GhostButton
                                            ...
                                            onClick={() => {
                                                setImportFromAnkiDialogueVisible(
                                                    todayCards
                                                );
                                            }}
                                            view={view}
